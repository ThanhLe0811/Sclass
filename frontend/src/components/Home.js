...
function Home() {
  ...
  return (
    <div className="container mt-4">
       {/* lastest Courses */}
       <h3 className="pb-1 mb-4"> Lastest Courses<Link to="/all-courses" className="float-end">See All</Link></h3>
        ...
        <div className="row mb-4">
         ...
         {/* End Popular Courses */}
          {/* Featured Teachers */}
          <h3 className="pb-1 mb-4 mt-5"> Featured Teachers<Link to="/popular-teacher" className="float-end">See All</Link></h3>
        <div className="row mb-4">
            <div className="col-md-3">
                <div className="card">
         ...
         {/* End Popular Teachers */}
          ...
          <div id="carouselExampleIndicators" className="carousel slide bg-light py-5" data-bs-ride="carousel">
